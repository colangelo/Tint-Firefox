...
- **16 preset colors**: Extended palette with popular color choices
...
### Custom Color Mode (New in v3.0)
1. Click the extension toolbar button (colorful window icon)
2. Choose from 16 preset colors or use the custom color picker
